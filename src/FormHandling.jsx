  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <form onSubmit={submitHandler}>
        {warning && <p className="text-red-500 text-center mb-4">{warning}</p>} {/* Display warning message */}
        ...
        <button className="w-full bg-blue-500 text-white font-semibold p-3 rounded-md hover:bg-blue-600 transition" type="submit">
          Submit
        </button>
      </form>
    </div>
